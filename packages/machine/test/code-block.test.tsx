...
test('markdown code blocks wrap long lines without forcing all code blocks to wrap', () => {
  ...
  expect(markdownHtml).not.toContain('[&amp;_.line]:block')
  expect(typescriptHtml).toContain('sm:overflow-x-auto')
  expect(typescriptHtml).toContain('sm:whitespace-pre')
  expect(typescriptHtml).not.toContain('[&amp;_.line]:block')
})
