...
- **styles:** require Tailwind CSS v4 and remove the legacy `blackwork/tailwind-config` entrypoint
...
- **social-link:** render external icon links as one accessible interactive element
...
- **styles:** include the animation utilities required by interactive components in `blackwork/tailwind.css`
- **theme:** use the configured theme label for the toggle's hidden accessible text
...
- **rsc:** expose `ThemeScript` from the server-renderable entrypoint
...
- **quick-search:** remove dialog slide animation ([59753b1](https://github.com/chengpeiquan/blackwork/commit/59753b1a717bf50cad57ea9f1b2ea682d807c434))

### Features

- **docs-navigation:** add mobile docs controls ([6de9a96](https://github.com/chengpeiquan/blackwork/commit/6de9a969dfff918bec94e6f184cc6de414564d64))
- **layouts:** forward native header and footer props ([89b28ad](https://github.com/chengpeiquan/blackwork/commit/89b28ad16a27366cac733236710d68decb64ce77))
- **rsc:** add server-renderable entrypoint and align package output ([50b40a8](https://github.com/chengpeiquan/blackwork/commit/50b40a8130b13f737b197432ad5fd41c4bf9e41b))
- **tailwind-config:** add package-aware content resolver ([2175aad](https://github.com/chengpeiquan/blackwork/commit/2175aadbabb903c59e4e18cce44fdd7769345336))
- **tailwind-entry:** expose blackwork v4 styles ([6af7f36](https://github.com/chengpeiquan/blackwork/commit/6af7f36a1471d211a0ce7fc0923a2f221d6eeeb5))
