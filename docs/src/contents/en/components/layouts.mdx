...
Set `appearance="glass"` on `LayoutHeader` when the header should sit over the page background. See [Liquid glass](/components/glass) for the shared theme configuration.
