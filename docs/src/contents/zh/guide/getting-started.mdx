...
页面运行后，先在浅色和深色主题下各检查一次，再继续查看 [布局](/zh/components/layouts)、[主题](/zh/components/theme) 和 [小工具](/zh/components/widgets) 的用法。[组件总览](/zh/components) 列出了其他可用组件，也说明了参考 shadcn/ui 示例时需要注意的 API 差异。
